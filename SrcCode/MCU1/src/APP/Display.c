...
void DisplayTimeMode_Runnable(void)
{
	...
	if(G_enuMode==DISPLAY_MODE)
	{
		...
		if (G_u8MSecs==1000)
		{
			 if((G_u8CurrCol==UNITS_DIGIT_SECS||G_u8CurrCol==TENS_DIGIT_SECS)&&G_u8CurrRow==SECOND_ROW)
			{
				 Loc_u8SecondsBackup++;
				G_u8MSecs=0;
			}
		...
		{
			G_u8Secs=0;
			if((G_u8CurrCol==UNITS_DIGIT_MINS||G_u8CurrCol==TENS_DIGIT_MINS)&&G_u8CurrRow==SECOND_ROW)
			{
				Loc_u8MinsBackup++;
		...
		{
			G_u8Mins = 0;
			if((G_u8CurrCol==UNITS_DIGIT_HOURS||G_u8CurrCol==TENS_DIGIT_HOURS)&&G_u8CurrRow==SECOND_ROW)
			{
				Loc_u8HoursBackup++;
		...
		{
			G_u8hours = 0;
			if((G_u8CurrCol==UNITS_DIGIT_DAY||G_u8CurrCol==TENS_DIGIT_DAY)&&G_u8CurrRow==FIRST_ROW)
			{
				Loc_u8DaysBackup++;
